...
public class DefaultMessages {
    public static void setDefaultMessages() {
        ...
        ServerConfig.setMessage(
                "wrongIdentity", "Unable to verify your identity (incorrect signature); do you have the correct key?");
        ServerConfig.setMessage(
                "kickNoKey", "You cannot join without being bound in advance. Contact a server admin to let you in.");
        ...
        ServerConfig.setMessage(
                "noKeyBannerHint", "§aClick this text or type \"§f/offauth bind§a\" to bind your key!§r");
        ServerConfig.setMessage(
                "noKeyGrace",
                "§6The server will reject users without a key; you have a short grace period to bind again.§r");
